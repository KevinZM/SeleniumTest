...
Select(driver.find_element_by_id("StoragePopupView_availableStorageItems")).select_by_value("Data / NFS")
driver.find_element_by_xpath(".//*[@id='NfsStorageView_pathEditor']").send_keys("192.168.8.240:/mnt/hdd/datadomain/mcos")
driver.find_element_by_id("StoragePopupView_OnSave").click()
element3 = WebDriverWait(driver, 10).until(
    lambda drive: driver.find_element_by_xpath(".//*[@id='MainTabStorageView_table_content_col3_row0']"))
time.sleep(2)
#验证
